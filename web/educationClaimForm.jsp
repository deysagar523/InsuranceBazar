        ...
        <main class="form-control w-25 m-auto">
            <div class="mt-3">
                <div class="card-header">
                    ...
                    <h1 class="h3 mb-3 fw-normal text-center" style="color: #301934"><b>File An Education Claim</b></h1>
                </div>
                <form action="AddClaim" method="Post">
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control" id="floatingInput" placeholder="Education Details" name="educationDetails" required>
                        <label for="floatingInput">Education Details</label>
                    </div>
