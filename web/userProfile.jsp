                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-start align-items-sm-center  ">
                            <img src="https://media.licdn.com/dms/image/C5103AQEOeanpgPHjvQ/profile-displayphoto-shrink_800_800/0/1535103569699?e=1682553600&v=beta&t=HCWckhcZjlq3JikB0SKYanExj58faqdmA-uUI_6Xn8Q" alt="user-avatar" class="d-block rounded" height="100" width="100px" 
                            id="uploadedAvatar" />
...
<!--                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="DOB" name="organization" value="AtranaTheme" />
                                </div>-->
