...
/* sourceMappingURL=style.css.map */
	...
	<body>
		<div class="wrapper">
                    ...
                    <form action="CreateTravelClaim" id="wizard" method="post">
        		<!-- SECTION 1 -->
                <h2></h2>
                <section>
                    <div class="inner">
						...
						<div class="form-content" >
							...
							<div class="form-row">
								<div class="form-holder">
									  <input type="text" value="${User.getUserId()}" class="form-control" id="floatingInput" placeholder="Driver Name" name="userId" required>
                                                                ...
                                                                <div class="form-row">
								<div class="form-holder">
									  <input type="text" value="${User.getFullName()}" class="form-control" id="floatingInput" placeholder="Driver Name" name="fullName" required>
								</div>
								
							</div>
                                                                <div class="form-row">
								<div class="form-holder">
									  <input type="text" value="${User.getEmail()}" class="form-control" id="floatingInput" placeholder="Driver Name" name="email" required>
								</div>
							...
							<div class="form-row">
                                                            ...
                                                            <div class="form-holder">
									<input type="text" placeholder="Travel Destination" name="travelDestination" class="form-control">
								</div>
                ...
                <section>
                    <div class="inner">
						...
						<div class="form-content">
							...
							<div class="form-holder">
									<input type="date" placeholder="Travel Start Date" name="travelStartDate" class="form-control">
								</div>
							<div class="form-row">
								<div class="form-holder">
									<input type="date" placeholder="Select Bike Reg. Year YYYY" name="travelEndDate" class="form-control">
								</div>
                                                            <div class="form-holder">
                    ...
                    <div class="inner">
						...
						<div class="form-content">
							...
							<div class="form-row">
									...
									<textarea  id="" placeholder="MedicalHistory" name="medicalHistory" class="form-control" style="height: 99px;"></textarea>
								</div>
								<div class="form-holder w-100">
