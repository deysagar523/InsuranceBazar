...
<html class="no-js" lang="zxx">
    ...
    <body>
                ...
                <div class="formbold-form-wrapper">
                    <form action="UpdateBikeClaim" method="POST">
                        ...
                        <div class="formbold-input-flex">
                            ...
                            <div>
                                <c:choose>
                                    <c:when test="${Claim.getBikeMake().equalsIgnoreCase('HO')}">
                                        <input
                                            type="text"
                                            name="bikeMake"
                                            id="phone"
                                    ...
                                    <c:when test="${Claim.getBikeMake().equalsIgnoreCase('BA')}">
                                        <input
                                            type="text"
                                            name="bikeMake"
                                            id="phone"
                                    ...
                                    <c:when test="${Claim.getBikeMake().equalsIgnoreCase('YA')}">
                                        <input
                                            type="text"
                                            name="bikeMake"
                                            id="phone"
                                    ...
                                    <c:when test="${Claim.getBikeMake().equalsIgnoreCase('RE')}">
                                        <input
                                            type="text"
                                            name="bikeMake"
                                            id="phone"
                                    ...
                                    <c:when test="${Claim.getBikeMake().equalsIgnoreCase('SU')}">
                                        <input
                                            type="text"
                                            name="bikeMake"
                                            id="phone"
                                    ...
                                    <c:when test="${Claim.getBikeMake().equalsIgnoreCase('HD')}">
                                        <input
                                            type="text"
                                            name="bikeMake"
                                            id="phone"
                                    ...
                                    <c:when test="${Claim.getBikeMake().equalsIgnoreCase('HM')}">
                                        <input
                                            type="text"
                                            name="bikeMake"
                                            id="phone"
                                    ...
                                    <c:when test="${Claim.getBikeMake().equalsIgnoreCase('MA')}">
                                        <input
                                            type="text"
                                            name="bikeMake"
                                            id="phone"
                                ...
                                <div class="formbold-input-flex">
                                    ...
                                    <div>
                                        <input
                                            ...
                                            id="phone"
                                            required
                                            pattern="[0-920-23]{3}[-]{1}[0-9]{5}[-]{1}[0-9]{4}[-]{1}[0-9]{3}"
                                            title="Check police report number"
                                            style="width:auto"
                                            class="formbold-form-input"
                                            />
                                        <label for="phone" class="formbold-form-label"> Police Report Number </label>
        ...
        <style>
            @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap');1000
