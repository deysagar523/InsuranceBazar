    ...
    <div class="container-fluid bg-dark px-5 d-none d-lg-block">
        <div class="row gx-0">
            ...
            <div class="col-lg-4 text-center text-lg-end">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                   <a class="btn" href="https://www.twitter.com/">welcome ${User.getFullName()}</a>
...
<!--                    <a href="index.html" class="nav-item nav-link active">Home</a>
                    ...
                    <a href="service.html" class="nav-item nav-link">Services</a>-->
                     ...
                     <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Insurance Products</a>
                        
                        <div class="dropdown-menu m-0">
                            <c:forEach items="${Categories}" var="cat">
                                <a style="cursor:pointer;" onClick="laodPolicies(<c:out value="${cat.categoryId}"> </c:out>)" class="dropdown-item"><i class="fa fa-umbrella" style="font-size:20px;color:greenyellow"></i> ${cat.getCategoryName()}</a>
                                
                            </c:forEach>
                                
                            <ul style="background-color: #D3D3D3" class="side-dropdown" id="policiesContainer"></ul>
