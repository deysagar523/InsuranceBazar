...
/* sourceMappingURL=style.css.map */
	...
	<body>
       ...
       <form action="CreateHealthClaim" method="post" id="wizard">
        		<!-- SECTION 1 -->
                <h2></h2>
                <section>
                    <div class="inner">
						<div class="image-holder">
                                                    <img src="img/healthimg.jpg" alt="">
						</div>
						<div class="form-content" >
							...
							<div class="form-row">
								<div class="form-holder">
									<input type="text" value="${User.getUserId()}" name="userId" class="form-control">
								</div>
								<div class="form-holder">
									<input type="text" value="${User.getFullName()}" name="fullName" class="form-control">
								</div>
							</div>
							<div class="form-row">
								<div class="form-holder">
									<input type="text" value="${User.getEmail()}" name="email" class="form-control">
								</div>
                ...
                <section>
                    <div class="inner">
						...
						<div class="form-content">
							...
							<div class="form-row">
								<div class="form-holder w-100" id="box">
<!--									<input type="text" placeholder="Address" class="form-control">-->
                                                                    <div class="form-group" >
      <input name="medicalHistory" type="checkbox" id="html" value="existing illness">
      <label for="html"><b>Existing Illness</b></label>
    </div>
    <div class="form-group">
      <input name="medicalHistory" type="checkbox" value="surgical procedure" id="css">
      <label for="css">Surgical procedure</label>
    </div>
    <div class="form-group">
      <input name="medicalHistory" type="checkbox" value="none" id="javascript" value="none">
      <label for="javascript">None</label>
                                                        ...
                                                        <div class="form-row">
								<div class="form-holder">
									<input type="text" name="relation" placeholder="realtion" class="form-control">
								</div>
								<div class="form-holder">
									<input type="text" name="relativeName" placeholder="realtive name" class="form-control">
								</div>
                                                            <div class="form-holder">
