                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <div class="mo-mb-2">
                                                                                ...
                                                                                <c:choose>
                                                                                    ...
                                                                                    <c:when test ='${plan.getPlanCompany().equalsIgnoreCase("lic")}'>
                                                                                        <img
                                                                                            src="img/lic.png"
                                                                                            alt=""
                                                                                            class="img-fluid mx-auto d-block"
                                                                                    ...
                                                                                    <c:when test ='${plan.getPlanCompany().equalsIgnoreCase("tata")}'>
                                                                                        <img
                                                                                            src="img/tata.png"
                                                                                            alt=""
                                                                                            class="img-fluid mx-auto d-block"
                                                                                    ...
                                                                                    <c:when test ='${plan.getPlanCompany().equalsIgnoreCase("bajaj")}'>
                                                                                        <img
                                                                                            src="img/bajaj.png"
                                                                                            alt="bajaj"
                                                                                            class="img-fluid mx-auto d-block"
