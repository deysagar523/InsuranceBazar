        ...
        * {
        ...
        <body>
            <div class="wrapper">
                ...
                <form action="CreateCarClaim" id="wizard" method="post">
                    <!-- SECTION 1 -->
                    <h2></h2>
                    <section>
                        <div class="inner">
                            ...
                            <div class="form-content" >
                                ...
                                <div class="form-row">
                                    <div class="form-holder">
                                        <input type="text" value="${User.getUserId()}" class="form-control" id="floatingInput" placeholder="" name="userId" required>
                                    </div>

                                </div>
                                <div class="form-row">
                                    <div class="form-holder">
                                        <input type="text" value="${User.getFullName()}" class="form-control" id="floatingInput" placeholder="" name="fullName" required>
                                    </div>

                                </div>
                                <div class="form-row">
                                    <div class="form-holder">
                                        <input type="text" value="${User.getEmail()}" class="form-control" id="floatingInput" placeholder="" name="email" required>
                                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-holder">
                                        <input type="text" placeholder="Car Number" name="carNo" class="form-control">
                                    </div>
                                    <div class="form-holder">
                                        <input type="text" placeholder="Car Moddele" name="carModel" class="form-control">
                                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-holder">
                                        <input type="date" placeholder="Select car Reg. Year YYYY" name="carRegistrationYear" class="form-control">
                                    </div>
                    ...
                    <section>
                        <div class="inner">
                            ...
                            <div class="form-content">
                                ...
                                <div class="form-row">
                                    <div class="form-holder">
                                        <input type="text" placeholder="Incident Location" name="incidentLocation" class="form-control">
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="form-holder">
                                        <input type="date" placeholder="Incident date" name="incidentDate" class="form-control">
                                    </div>
                    ...
                    <section>
                        <div class="inner">
                            ...
                            <div class="form-content">
                                ...
                                <div class="form-row">
                                    <div class="form-holder">
                                        <input type="text" placeholder="Police Report No" name="policeReportNo" class="form-control">
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="form-holder">
                                        <input type="text" placeholder="Write yor messge here" name="message" class="form-control">
                                    </div>
