                ...
                <div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
                    <div class="wrapper wrapper--w790">
                        ...
                        <div class="card card-5">
                            ...
                            <div class="card-body">
                                <form action="CreateChildClaim" method="POST">
                                    <div class="form-row">
                                        <div class="name">Name</div>
                                        <div class="value">
                                            <div class="input-group">
                                                <input class="input--style-5" type="text" name="fullName" value="${User.getFullName()}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="value">
                                        <div class="input-group">
                                            <input class="input--style-5" type="text" name="userId" value="${User.getUserId()}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="value">
                                        <div class="input-group">
                                            <input class="input--style-5" type="email" name="email" value="${User.getEmail()}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!--                        <div class="form-row">
                                                            ...
                                                            <div class="value">
                                                                <div class="input-group">
                                                                    <input class="input--style-5" type="text" name="phone" value="${User.getPhone()}">
                                                                </div>
                                                            </div>
                                                        </div>-->
                                <div class="form-row">
                                    ...
                                    <div class="value">
                                        <div class="input-group">
                                            <input class="input--style-5" type="text" name="age" value="${User.getAge()}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="value">
                                        <div class="input-group">
                                            <input class="input--style-5" type="text" name="childName">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="value">
                                        <div class="input-group">
                                            <input class="input--style-5" type="text" name="childBirthNo">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row p-t-20">
                                        ...
                                        <div class="p-t-15">
                                            <label class="radio-container m-r-55">Male
                                                <input type="radio" checked="checked" value="male" name="childGender">
                                                <span class="checkmark"></span>
                                            </label>
                                            <label class="radio-container">Female
                                                <input type="radio" value="female" name="childGender">
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                    </div>
