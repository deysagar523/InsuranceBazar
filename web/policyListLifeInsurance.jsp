                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <c:if test="${User.role.equals('2')}">
                                        <c:if test="${AllPendingLifeInsuranceClaims.size()!=0}">
                                            <c:forEach items="${AllPendingLifeInsuranceClaims}" var="claim">
                                                <tr data-index="0">
                                ...
                                <c:if test="${User.role.equals('3')}">
                                    <c:if test="${AllApprovedLifeInsuranceClaims.size()!=0}">
                                        <c:forEach items="${AllApprovedLifeInsuranceClaims}" var="claim">
                                            <tr data-index="0">
                                                <td><c:out value="${claim.medicalHistory}"> </c:out></td>
                                                <td><c:out value="${claim.relation}"> </c:out>
                                                <td><c:out value="${claim.dob}"> </c:out></td>
