...
<html lang="en">
        ...
        <div class="sidebar transition overlay-scrollbars animate__animated  animate__slideInLeft">
            <div class="sidebar-content"> 
                <div id="sidebar">
                    ...
                    <ul class="side-menu">
                        <li>
                            <a href="underwriterHomePage.jsp" class="active" style="background-color: #09470e;">
    ...
    <!--Content Start-->
    <div class="content-start transition" style="background-color: #d0f2f2;" id="container">
                            ...
                            <div class="card-body"> 
                                <div class="table-responsive"> 
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <c:forEach items="${AllLatestClaims}" var="claim">
                                                <tr >
                                                    ...
                                                    <c:if test="${claim.claimStatus.equalsIgnoreCase('2')}">
                                                        <td><span class="text-success">Approved</span></td> 
                                                    </c:if>
                                                    <c:if test="${claim.claimStatus.equalsIgnoreCase('4')}">
